  ...
  const menuItems = [
    ...
    { 
      name: "Report", path: "/report", icon: <FaFileAlt />, dropdown: true, subItems: [
        { name: "Fuel Transaction History", path: "/report/fueltransaction" },
          ...
          {menuItems.map((item) => (
            <React.Fragment key={item.name}>
              ...
              >
                ...
                {item.dropdown && (reportOpenDesktop ? <FaChevronDown /> : <FaChevronRight />)}
              </ListGroup.Item>
              {item.dropdown && reportOpenDesktop && (
            ...
            {menuItems.map((item) => (
              <React.Fragment key={item.name}>
                ...
                >
                  ...
                  {item.dropdown && (reportOpenMobile ? <FaChevronDown /> : <FaChevronRight />)}
                </ListGroup.Item>
                {item.dropdown && reportOpenMobile && (
                  <div className="bg-secondary">
                    {item.subItems.map((subItem) => (
                      <ListGroup.Item
                        key={subItem.name}
